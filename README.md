...
2. 在具体官方活动页点击“读取活动信息”。大麦详情页可识别标题、场馆、明确列出的全部场次、单笔限购及公开价格范围；其他平台在页面含标准公开活动标记时，可带入明确的日期、票档名称和单价。候票台把**当前来源明确列出的所有场次**一起加入一项演出任务，无需逐场选择；有逐档名称与单价时会列成卡片，你按偏好点选票档，再选人数，点击“开始购票”保存任务并打开本场官方入口。没有额外的预算输入，也不设置隐藏的金额上限。旧版单场次任务仍可读取。只有价格范围而无逐档价格时，界面会明确提示，**不会**把范围上下限冒充票档；App 专属项目可直接尝试打开手机上的官方 App 查看票档，不能从网页推断 App 内所有可买票位。软件不会把日期范围猜成具体日期，也不自动推断不明确的所在地时区。
