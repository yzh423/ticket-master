...
2. 在具体官方活动页点击“读取活动信息”。大麦详情页可识别标题、场馆、明确列出的候选场次及公开价格范围；其他平台在页面含标准公开活动标记时，可带入明确的日期、票档名称和单价。候票台会把识别到的场次和票档变成可点选项：选择场次、按偏好顺序选择票档，再选人数和总预算余量即可建任务。预填资料可展开核对和修改。只有价格范围而无逐档价格时，界面会明确提示，**不会**把范围上下限冒充票档；该类项目仍须在原平台查看准确票档。软件不会把日期范围猜成固定场次，也不自动推断不明确的所在地时区。
