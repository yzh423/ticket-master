...
候票台是一款中文购票准备工具，提供 **Windows 桌面版**和**本地网页版本**。新版只保留三个入口：**找票、任务、设置**。搜索活动或粘贴官方链接后，桌面版在同一窗口打开官网；识别到公开信息时，你只需点选场次、票档和人数，就能保存任务并进入官方购票流程。
...
1. 打开“找票”，输入歌手、活动名或粘贴官方活动链接。默认使用大麦；点击平台按钮可切换当前提供的 20 个官网入口。大麦和 Ticketmaster 支持关键词直达搜索，其他渠道会在窗口内打开官网供你站内查找。票星球、纷玩岛等尚无经核实的通用网页首页入口，可从具体活动官方链接进入，或使用原生 App。
2. 打开具体官方活动页后，桌面版会尝试读取公开活动信息；未出现识别结果时可点“读取活动信息”重试。大麦详情页可识别标题、场馆、明确列出的场次、单笔限购及公开价格范围；其他平台在页面含标准公开活动标记时，可带入明确的日期、票档名称和单价。右侧“购票准备”只要求你选择场次、按偏好点选票档并选人数；点击“准备并打开官方购票”保存任务并进入本场官方入口。平台、场馆、来源和核实日期自动带入；没有预算输入，也不设置隐藏的金额上限。只有价格范围而无逐档价格时，界面会明确提示，**不会**把范围上下限冒充票档；App 专属项目可尝试打开手机官方 App 查看票档，不能从网页推断 App 内所有可买票位。软件不会把日期范围猜成具体日期，也不自动推断不明确的所在地时区；无法确定时，仍需核对活动时区。
...
手机参与时，在“设置 → 手机与数据”确认 Android 已授权，再从任务打开大麦原生 App；目前无法保证从网页直达具体活动。请在 App 内搜索活动，核对场次、票档、实名观演人与最终结算金额，按官方排队、下单和付款流程完成。桌面任务负责展示你选好的条件与销售机会提醒，手机上的账号登录、人员登记和支付始终留在原平台。iPhone 不支持 ADB，需手动打开相应官方 App。

“任务”会根据已录入的销售机会、准备项和订单阶段，只突出一个当前动作并直达相应步骤；临近开售或出现待支付订单时，详情页进入专注模式，把倒计时和官方入口放在最前面。“设置 → 平台说明”提供演出发现、原生票务和网页监控工具的对照。它不读取实时库存，也不是抢票概率评分，详细依据见[同类工具对照与升级方向](docs/同类工具对照与升级方向.md)。
